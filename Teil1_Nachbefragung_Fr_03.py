...
plot_likert_bar(
    counts_all,
    title="Selbsteinschätzung (Nach_Fr_03) – Overall",
    color="skyblue",
...
plot_group_comparison(
    counts_by_gender,
    title="Selbsteinschätzung (Nach_Fr_03) – Geschlecht",
...
plot_group_comparison(
    counts_by_age,
    title=f"Selbsteinschätzung (Nach_Fr_03) – Alter (<{AGE_CUT} vs. ≥{AGE_CUT})",
